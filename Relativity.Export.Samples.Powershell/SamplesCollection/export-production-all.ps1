...
'{
    "settings": {
        ...
        "ExportArtifactSettings": {
            ...
            "ImageExportSettings": {
                "ImagePrecedenceArtifactIDs":[' + $productionId + '],
                "TypeOfImage":2,
            },
            ...
            "NativeFilesExportSettings": {
                "NativePrecedenceArtifactIDs":[' + $productionId + ']
            },
        ...
        "ExportOutputSettings": {
            "LoadFileSettings": {
                "LoadFileFormat":"CSV",
                "ImageLoadFileFormat":"IPRO_FullText",
...
Context "Exports native, fulltext, images and PDF files from production set" {
