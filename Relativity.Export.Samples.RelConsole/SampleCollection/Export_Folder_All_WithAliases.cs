...
{
    [SampleMetadata(nameof(Export_FromFolder_All_WithAliases), "Exports native, fulltext, images and PDF files from folder and uses field aliases")]
    public async Task Export_FromFolder_All_WithAliases()
    {
        // Your workspace ID.
