...
public partial class BaseExportService
{
    ...
    public async Task Export_Folder_All_With_DataSource_Name_In_Loadfile()
    {
        ...
        var loadfileSettings = LoadFileSettingsBuilder.Create()
            ...
            .WithLoadfileNameFormat(LoadfileNameFormat.WithDataSourceNameAndDate) // exported loadfiles names with following naming convention: #TypeOfExport#_#SourceName#_#DateTime#_export.dat
