...
{
    [SampleMetadata(nameof(Export_FromFolder_All_With_Aliases), "Exports native, fulltext, images and PDF files from folder and uses field aliases")]
    public async Task Export_FromFolder_All_With_Aliases()
    {
        // Your workspace ID.
        ...
        List<int> fieldArtifactIDs = new() { 1003676, 1003667 };
        Dictionary<int, string> fieldAliases = new()
        {
            { 1003676, "Field1" },
            { 1003667, "Field2" }
        };
        ...
        var artifactSettings = ExportArtifactSettingsBuilder.Create()
            ...
            .WithFieldArtifactIDs(fieldArtifactIDs) // Fields to export
        ...
        _logger.PrintAliases(fieldAliases);
        ...
        {
            _logger.LogError("Something went wrong. Received empty response.");
            return;
        }
